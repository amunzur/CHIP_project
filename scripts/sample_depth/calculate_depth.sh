...
# find $PWD -name '*.bam' -a ! -name '*filtered*' | parallel -j10 -k bash /groups/wyattgrp/users/amunzur/chip_project/scripts/sample_depth/calculate_depth.sh
# ca variant_calling
...
output_file_txt="${dir_to_read_depth}new_finland_download_RAW.txt"
output_file_csv="${dir_to_read_depth}new_finland_download_RAW.csv"
