...
WBC_samples <- as.list(as.vector(samples_df$gDNA_sequencing_name))
...
dest <- "/groups/wyattgrp/data/bam/GU_finland_download"
...
# write to file
writeLines(unlist(lapply(FINAL_list, paste, collapse=" ")), "/groups/wyattgrp/users/amunzur/chip_project/scripts/transfer.txt")
